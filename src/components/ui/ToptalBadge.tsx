...
/**
 * Official Toptal destination for this profile — preserve exactly,
 * including the #XpxY8j fragment. Do not swap in a different Toptal URL or
 * route it through the portfolio's own /contact page.
 */
const TOPTAL_PROFILE_URL = "https://www.toptal.com/developers/resume/jaksa-brzovic#XpxY8j";

/**
 * Official Toptal "Top 3% Talent" white badge, reproduced from the embed
 * Toptal's badge generator issued for this profile. Markup/colors/wording
 * are copied verbatim — only the CSS selectors were renamed and scoped (see
 * ToptalBadge.module.css) and the SVGs adapted to JSX attribute casing.
 */
    ...
    <div className={cn(styles.root, className)}>
      <div className={styles.hex}>
        <div className={styles.inner}>
          <svg width="64" viewBox="0 0 60 17" aria-hidden="true">
            <path
          ...
          <p className={styles.title}>TOP 3% TALENT</p>
          <div className={styles.divider} />
          <span className={styles.subtitle}>Vetted by</span>

          <svg style={{ width: "100px" }} viewBox="0 0 108 30" role="img" aria-label="Toptal">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
